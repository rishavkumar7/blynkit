...
const CategoryChip = ({ category, removeCategory }) => {
    ...
    return (
        <div className="relative group w-fit bg-amber-50 text-xs px-2 py-1 rounded-2xl whitespace-nowrap flex items-center hover:bg-[linear-gradient(to_left,_rgba(1,1,1,0.6)_10%,_transparent_50%)]">
