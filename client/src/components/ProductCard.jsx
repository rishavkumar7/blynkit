...
const ProductCard = ({ openEditSpace, openConfirmBox, product }) => {
        ...
        <div className="w-full h-full flex flex-col items-center justify-center shadow-[0_0_10px_1px_rgba(0,0,0,0.2)] rounded-lg">
            <div className="relative group w-full flex items-start justify-center aspect-[0.9] sm:aspect-[1.0] md:aspect-[1.1] lg:aspect-[1.3] overflow-hidden rounded-lg" >
                ...
                <div className="absolute top-1 right-2 hidden group-hover:flex flex-col items-center justify-center gap-2 z-1">
                    <button onClick={ handleDeleteProductButtonClick } className="text-white bg-transparent cursor-pointer"><RiDeleteBin6Line size={ 30 } /></button>
                    <button onClick={ handleEditProductButtonClick } className="text-white bg-transparent cursor-pointer"><TiEdit size={ 30 } /></button>
                </div>
